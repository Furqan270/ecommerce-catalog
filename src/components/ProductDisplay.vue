<template>
    <div class="container">
        ...
        <div v-else class="container" :class="
            !isProductAvailable
                ? 'bg-gray'
        ...
        ">
            <div class="overlay">
                <img src="../assets/Group20.svg" alt="background overlay" />
            </div>
            <div class="card">
                <div v-if="!isProductAvailable" class="product-unavailable-container">
                    <div class="overlay">
                        <img src="../assets/sad-face.svg" alt="background unavailable product" srcset="" />
                    </div>
                    ...
                    <div class="product-details">
                        ...
                        <div class="bottom">
                            ...
                            <div class="cta">
                                ...
                                <button type="button" @click="getSingleProduct()" :class="
                                    product.data.category === 'men\'s clothing'
